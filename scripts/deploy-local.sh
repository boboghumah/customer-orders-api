...
DEFAULT_HEALTH_HOST="localhost"
if [ -f "/.dockerenv" ]; then
  DEFAULT_HEALTH_HOST="host.docker.internal"
fi
HEALTH_HOST="${HEALTH_HOST:-${DEFAULT_HEALTH_HOST}}"
HEALTH_URL="${HEALTH_URL:-http://${HEALTH_HOST}:${HOST_PORT}/actuator/health}"
